...
GoHealth UC is an active Jairosoft client with engagement on **two tracks**:
...
### Voice AI initiative side
- [[people/eli-hersher]] — Product Owner (MarTech & CX); primary contact for Voice AI evaluation.

### Engineering / weekly-alignment side
- [[people/susan-neunaber]] — Manager, Agile Delivery & Governance (PMP, CSM); primary recurring counterpart on Weekly Alignment.
- [[people/derek-norton]] — Senior counterpart; on Weekly Alignment + touch-bases.
- [[people/justin-patel]] — On Weekly Alignment; investigating Zotec issues.
- [[people/padma-alla]] — On Weekly Alignment.
- [[people/mateen-kazia]] — Patient-app refactor (front-end / engineering).
- [[people/josh-newton]] — IAM team; Okta verification.

## Active engagements

- [[projects/gohealth-voice-ai-initiative]] — Vendor Response submitted 2026-04-24; next steps pending.
- [[projects/gohealth-jairosoft-engineering-engagement]] — 9-person Jairosoft dev team; weekly alignment running ~since 2026-03-14; multiple workstreams (Hartford integration, EMR HL7/R4, patient-app refactor, Save My Spot redesign).

## Timeline

- 2026-03-04 — Discussion surfacing transfer-latency pain in current Amazon Connect IVR.
- 2026-04-20 — Derek Norton accepts touch-base with Jairosoft. → [[sources/2026-04-20-derek-norton-accepted-touchbase]]
...
- [[projects/gohealth-voice-ai-initiative]]
