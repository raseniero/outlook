---
type: project
title: "Hishaam Namooya — Employment Opportunity"
status: in-discussion
counterpart_person: hishaam-namooya
owner_us: ramon-aseniero
tags: [hiring, talent, sitecore, mauritius, in-discussion]
...
Next call scheduled for **2026-04-27 (Monday)** to discuss:
1. Future software engineer idea (Ramon's concept — TBD what specifically).
2. Hishaam's AI development progress (skill update).
...
- [ ] **Ramon — Monday 2026-04-27:** prepare position framing for the call; align on the future-engineer idea, AI feedback, and offer status.
